 ...
 */
public class CameraActivity extends AppCompatActivity implements Camera2BasicFragment.onPictureCapture, LabelFragment.OnFragmentInteractionListener {
    /**
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if (mContentView != null){
            ...
            getFragmentManager().beginTransaction()
                    .add(R.id.fragment_container,Camera2BasicFragment.newInstance()).commit();
    ...
    /**
     * Callback for Image Capture, should switch fragments
     */
    @Override
